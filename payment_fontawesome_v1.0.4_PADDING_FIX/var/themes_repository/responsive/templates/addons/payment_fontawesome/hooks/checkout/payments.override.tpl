            ...
            >
                {if $payment.fa_icon_class}
                    <div class="litecheckout__shipping-method__logo">
                        <i class="{$payment.fa_icon_class} litecheckout__shipping-method__logo-icon" {if $payment.fa_icon_style}style="{$payment.fa_icon_style}"{else}style="font-size: 2em;"{/if}></i>
                    </div>
